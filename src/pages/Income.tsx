...
const Income: React.FC = () => {
    ...
    return (
        <div className="expenses-page-mobills fade-in">
            <header className="mobills-page-header">
                <div className="header-left">
                    <div className="breadcrumb-pill green">
                        <div className="icon-green"><TrendingUp size={14} /></div>
                        <span className="breadcrumb-text">Receitas</span>
                        <ChevronRight size={14} opacity={0.3} />
                    </div>
                </div>

                <div className="header-right">
                    <button className="btn-add-mobills green" onClick={() => setIsModalOpen(true)}>
            ...
            <main className="mobills-main-content">
                <div className="work-area">
                    <div className="month-navigator">
                        <button className="nav-arrow green"><ChevronLeft size={20} /></button>
                        <div className="month-display green">
                            {format(new Date(referenceMonth + '-01'), "MMMM yyyy", { locale: ptBR })}
                        </div>
                        <button className="nav-arrow green"><ChevronRight size={20} /></button>
                    </div>
                            ...
                            <tbody>
                                {filteredIncome.map(t => (
                                    <tr key={t.id} className="mobills-row">
                                        ...
                                        <td className="value-cell text-right green">{formatCurrency(t.value)}</td>
                ...
                <aside className="summary-sidebar">
                    ...
                    <div className="summary-card-mobills">
                        ...
                        <div className="icon-bg green-dark"><ArrowDown size={20} /></div>
                    </div>
                    ...
                    <div className="summary-card-mobills">
                        ...
                        <div className="icon-bg green-scale"><Scale size={20} /></div>
                    </div>
                </aside>
            </main>
        ...
        .breadcrumb-pill.green { background: #f0fdf4; }
        .icon-green { background: var(--mobills-green); color: white; width: 20px; height: 20px; border-radius: 50%; display: flex; align-items: center; justify-content: center; }
        .breadcrumb-text { font-weight: 700; color: var(--mobills-green); font-size: 13px; }
        ...
        .btn-add-mobills.green { color: var(--mobills-green); }
        ...
        .month-display.green { border-color: var(--mobills-green); color: var(--mobills-green); }
        .nav-arrow { color: var(--mobills-red); background: transparent; border: none; cursor: pointer; }
        .nav-arrow.green { color: var(--mobills-green); }
        ...
        .value-cell.green { color: var(--mobills-green); }
        ...
        .icon-bg.green { background: var(--mobills-green); }
        .icon-bg.green-dark { background: #2f8540; }
        .icon-bg.green-scale { background: #48bb78; }
