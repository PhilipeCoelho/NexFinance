...
const Expenses: React.FC = () => {
    ...
    // Removido getAdjustedDate local, usando FinancialEngine.getAdjustedDate
    ...
    const summaryPanel = (
        <div className="sys-summary-widget">
            ...
            <div className="sys-summary-block">
                <span className="sys-summary-block-title">Pagas</span>
            ...
            <div className="sys-summary-block" style={{ borderBottom: 'none', paddingTop: '8px' }}>
                <span className="sys-summary-block-title" style={{ fontSize: '13px' }}>
                    {showIgnored ? 'Total (Incluindo Ignoradas)' : 'Total de Saídas'}
                </span>
